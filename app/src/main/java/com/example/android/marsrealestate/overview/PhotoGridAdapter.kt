...
class PhotoGridAdapter :
    ListAdapter<MarsProperty, PhotoGridAdapter.MarsPropertyViewHolder>(MarsItemCallbacks) {
    ...
    private companion object MarsItemCallbacks : DiffUtil.ItemCallback<MarsProperty>() {
